...
def get_parser():
    ...
    parser.add_argument('--num_output', default=129896, help='the image size')
...
if __name__ == '__main__':
    ...
    """
    tfrecords_f = tf.constant(["/data/face/dataset/cloud_train_min_10_1.tfrecords",
                               "/data/face/dataset/cloud_train_min_10_2.tfrecords"])
    dataset = tf.data.TFRecordDataset(tfrecords_f)
        ...
        while True:
            try:
                ...
                global_step_val, acc_val = sess.run([train_op,   loss_dict[loss_keys[0]],
                                                ...
                                                loss_dict[loss_keys[11]],global_step, acc],
                                                feed_dict=feed_dict)
                end = time.time()
