...
import argparse
from data.mx2tfrecords import _parse_function, _preprocess_function, _augment_function
import os
...
def get_parser():
    ...
    parser.add_argument('--net_depth', default=101, help='resnet depth, default is 50')
    ...
    parser.add_argument('--num_output', default=78771, help='the image size')
    ...
    parser.add_argument('--from_scratch', default=False, help='switch to train from scratch')
...
if __name__ == '__main__':
    ...
    """
    tfrecords_f = tf.constant(["/data/face/dataset/msceleb1m_train_1.tfrecords",
                               "/data/face/dataset/msceleb1m_train_2.tfrecords",
                               "/data/face/dataset/msceleb1m_train_3.tfrecords",
                               "/data/face/dataset/msceleb1m_train_4.tfrecords",
                               "/data/face/dataset/msceleb1m_train_5.tfrecords"])
    dataset = tf.data.TFRecordDataset(tfrecords_f)
    ...
    lr = tf.train.piecewise_constant(global_step, boundaries=lr_steps, values=[0.01, 0.001, 0.0001, 0.00001],
                                     name='lr_schedule')
    ...
    if args.from_scratch:
        ...
        checkpoint_dir = '/home/linkface/InsightFace_TF/output/ckpt/'
    ...
    for i in range(args.epoch):
		...
		inference_loss_val_gpu_3, wd_loss_val_gpu_3, total_loss_gpu_3, \
                global_step_val, acc_val = sess.run([train_op,   loss_dict[loss_keys[0]],
